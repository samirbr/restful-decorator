define(['exports', 'aurelia-http-client'], function (exports, _aureliaHttpClient) {
  ...
  _aureliaHttpClient.RequestBuilder.addHelper('withParams', function (params) {
  ...
  function rest(url, config) {
    ...
    function createRequest() {
      ...
      var client = new _aureliaHttpClient.HttpClient().createRequest().withBaseUrl(baseUrl).withParams(extraParams);
